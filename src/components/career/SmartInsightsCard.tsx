...
export function SmartInsightsCard({ stats, onQuickAction, isMobile }: SmartInsightsCardProps) {
  const insightText = stats.careerContacts > 0 
  ...
  if (isMobile) {
    const mobileInsightText = stats.careerContacts > 0 
