...
export function ApplicationInfoStage({ workflow, onUpdate }: ApplicationInfoStageProps) {
      ...
      {jobDescription && (
        <Card className="p-4 bg-blue-50/50 border-blue-100">
          <div className="flex items-center gap-2 mb-2">
            ...
            <span className="text-sm font-medium text-blue-900">Arlo's Quick Analysis</span>
          </div>
