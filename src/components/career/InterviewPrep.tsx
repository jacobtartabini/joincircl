    ...
    <div className="space-y-6">
      ...
      <div className="grid grid-cols-1 md:grid-cols-3 gap-4">
        {quickPrepOptions.map((option, index) => {
          ...
          return (
            <Card key={index} className="p-4 glass-card hover:glass-card-enhanced transition-all duration-200 cursor-pointer">
      ...
      <div>
        ...
        {sessions.length === 0 ? (
          <Card className="p-8 text-center glass-card">
            ...
            <Button onClick={() => setShowNewSessionDialog(true)} className="glass-button">
          ...
          <div className="space-y-3">
            {sessions.map((session) => (
              <Card key={session.id} className="p-4 glass-card">
                <div className="flex items-center justify-between">
                  <div className="flex-1 min-w-0">
