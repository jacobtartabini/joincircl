  ...
  return <div className="flex items-center gap-3">
      ...
      <DropdownMenu>
        <DropdownMenuTrigger asChild>
          <Button variant="outline" size="sm" className="h-10 px-3 border-gray-200 hover:bg-gray-50 transition-colors rounded-lg" aria-label="Sort and filter options">
      ...
      {/* Add Contact Button */}
      <Button onClick={onAddContact} size="sm" aria-label="Add new contact" className="h-10 px-4 bg-blue-600 hover:bg-blue-700 text-white transition-colors rounded-full">
