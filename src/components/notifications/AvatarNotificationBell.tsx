          ...
          {recentNotifications.length > 0 && (
            <div className="border-t border-gray-100 p-3 space-y-2">
              <Button 
                ...
                className="w-full text-xs hover:bg-[#0daeec]/5 rounded-full text-inherit"
              >
                View All
              </Button>
              <Button 
                ...
                className="w-full text-xs hover:bg-[#0daeec]/5 rounded-full text-inherit flex items-center gap-2"
              >
