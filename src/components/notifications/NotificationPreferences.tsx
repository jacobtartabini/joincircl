      ...
      <div className="space-y-6">
        <div>
          ...
          <div className="space-y-3">
            ...
            <div className="mt-3">
              <Button variant="outline" size="sm" onClick={handleTestNotification} disabled={!hasSubscription} className="rounded-full">
        ...
        <div>
          ...
          <div className="space-y-3">
            ...
            <div className="flex items-center justify-between">
              ...
              <Switch id="email-product-updates" checked={preferences.email.productUpdates} onCheckedChange={() => toggleEmailNotification('productUpdates')} />
            </div>
          </div>
        </div>
      </div>
