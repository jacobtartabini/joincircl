    ...
    <div className="h-full flex flex-col bg-white">
      ...
      <div className="panel-header">
        <div className="flex justify-end gap-2">
          ...
          {onDelete && (
            <Button variant="outline" size="sm" onClick={onDelete} className="text-xs">
              <Trash className="h-3 w-3 mr-1" />
              Delete
            </Button>
          )}
          {onViewAll && (
            <Button variant="outline" size="sm" onClick={onViewAll} className="text-xs">
          ...
          {interactions && interactions.length > 0 ? (
            <div className="space-y-3">
              ...
              {interactions.length > 3 && onViewAll && (
                <Button variant="ghost" size="sm" className="w-full text-xs mt-2" onClick={onViewAll}>
