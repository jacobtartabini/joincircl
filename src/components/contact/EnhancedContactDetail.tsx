...
export function EnhancedContactDetail({
  ...
  return <div className="h-full flex flex-col bg-white border-l border-gray-100">
      {/* Header with Actions */}
      <div className="border-b border-gray-100 bg-gray-50/50 p-6">
        <div className="flex justify-end gap-3">
          {onEdit && <Button variant="outline" size="sm" onClick={onEdit} className="h-9 px-4 text-sm font-medium border-gray-200 hover:bg-gray-50 hover:border-gray-300 transition-all duration-200 rounded-full">
              <Edit className="h-4 w-4 mr-2" />
              Edit
            </Button>}
          {onDelete && <Button variant="outline" size="sm" onClick={onDelete} className="h-9 px-4 text-sm font-medium border-red-200 text-red-600 hover:bg-red-50 hover:border-red-300 transition-all duration-200 rounded-full">
              <Trash className="h-4 w-4 mr-2" />
              Delete
            </Button>}
          {onViewAll && <Button variant="outline" size="sm" onClick={onViewAll} className="h-9 px-4 text-sm font-medium border-blue-200 text-blue-600 hover:bg-blue-50 hover:border-blue-300 transition-all duration-200 rounded-full">
      ...
      <ScrollArea className="flex-1">
        <div className="p-6 space-y-8">
          ...
          <div className="text-center pb-8 border-b border-gray-100">
            <Avatar className="h-20 w-20 mx-auto mb-4 shadow-sm">
              {contact.avatar_url ? <AvatarImage src={contact.avatar_url} alt={contact.name} /> : <AvatarFallback className="text-xl font-semibold bg-gradient-to-br from-blue-500 to-purple-600 text-white">
            ...
            {contact.location && <p className="text-sm text-gray-600 mb-4 flex items-center justify-center">
            ...
            <div className="flex flex-wrap gap-2 justify-center">
              ...
              {contact.tags && contact.tags.map(tag => <Badge key={tag} variant="secondary" className="bg-gray-100 text-gray-700 border-gray-200 font-medium">
                  {tag}
                </Badge>)}
            </div>
          </div>
          ...
          <div className="space-y-6">
            <div>
              ...
              <div className="space-y-4">
                {contact.personal_email && <div className="flex items-center gap-4 p-3 bg-gray-50 hover:bg-gray-100 transition-colors rounded-full">
                ...
                {contact.mobile_phone && <div className="flex items-center gap-4 p-3 bg-gray-50 hover:bg-gray-100 transition-colors rounded-full">
                ...
                {contact.birthday && <div className="flex items-center gap-4 p-3 bg-gray-50 hover:bg-gray-100 transition-colors rounded-full">
                ...
                {contact.website && <div className="flex items-center gap-4 p-3 bg-gray-50 hover:bg-gray-100 transition-colors rounded-full">
            ...
            {(contact.job_title || contact.company_name || contact.industry || contact.department || contact.work_address) && <div className="space-y-4">
                ...
                <div className="bg-gray-50 p-4 space-y-3 rounded-2xl">
                  ...
                  {contact.industry && <div className="text-sm text-gray-600 pl-7">
                      <span className="font-medium">Industry:</span> {contact.industry}
                    </div>}

                  {contact.department && <div className="text-sm text-gray-600 pl-7">
                      <span className="font-medium">Department:</span> {contact.department}
                    </div>}

                  {contact.work_address && <div className="text-sm text-gray-600 pl-7">
                ...
                <div className="bg-gray-50 p-4 rounded-2xl">
                  {contact.university && <div className="flex items-start gap-3">
                      ...
                      <div className="space-y-1">
                        ...
                        {contact.major && <p className="text-sm text-gray-600">
                            <span className="font-medium">Major:</span> {contact.major}
                            {contact.minor && ` • Minor: ${contact.minor}`}
                          </p>}
                        {contact.graduation_year && <p className="text-sm text-gray-600">
            ...
            {(contact.linkedin || contact.twitter || contact.facebook || contact.instagram) && <div className="space-y-4">
                ...
                <div className="space-y-3">
                  {contact.linkedin && <div className="flex items-center gap-4 p-3 bg-gray-50 hover:bg-gray-100 transition-colors rounded-full">
                      <div className="bg-blue-100 p-2 rounded-full">
                  ...
                  {contact.twitter && <div className="flex items-center gap-4 p-3 bg-gray-50 hover:bg-gray-100 transition-colors rounded-full">
                  ...
                  {contact.facebook && <div className="flex items-center gap-4 p-3 bg-gray-50 hover:bg-gray-100 transition-colors rounded-full">
                      <div className="bg-blue-100 p-2 rounded-full">
                  ...
                  {contact.instagram && <div className="flex items-center gap-4 p-3 bg-gray-50 hover:bg-gray-100 transition-colors rounded-full">
                      <div className="bg-pink-100 p-2 rounded-full">
            ...
            <div className="space-y-4">
              ...
              {interactions && interactions.length > 0 ? <div className="space-y-4">
                  ...
                  {interactions.length > 3 && onViewAll && <Button variant="ghost" size="sm" className="w-full mt-4 text-blue-600 hover:text-blue-700 hover:bg-blue-50 font-medium" onClick={onViewAll}>
