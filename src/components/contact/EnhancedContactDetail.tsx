      ...
      <ScrollArea className="flex-1">
        <div className="p-6 space-y-8">
          ...
          <div className="text-center pb-6 border-b border-gray-100">
            ...
            {contact.location && <p className="text-sm text-gray-600 mb-3 flex items-center justify-center">
          ...
          <div className="space-y-6">
            <div>
              ...
              <div className="space-y-3">
                {contact.personal_email && <div className="flex items-center gap-3 p-3 bg-gray-50 hover:bg-gray-100 transition-colors rounded-lg">
                ...
                {contact.mobile_phone && <div className="flex items-center gap-3 p-3 bg-gray-50 hover:bg-gray-100 transition-colors rounded-lg">
                ...
                {contact.birthday && <div className="flex items-center gap-3 p-3 bg-gray-50 hover:bg-gray-100 transition-colors rounded-lg">
                ...
                {contact.website && <div className="flex items-center gap-3 p-3 bg-gray-50 hover:bg-gray-100 transition-colors rounded-lg">
            ...
            {(contact.linkedin || contact.twitter || contact.facebook || contact.instagram) && <div className="space-y-4">
                ...
                <div className="space-y-3">
                  {contact.linkedin && <div className="flex items-center gap-3 p-3 bg-gray-50 hover:bg-gray-100 transition-colors rounded-lg">
                      <div className="bg-blue-100 p-2 rounded-lg">
                  ...
                  {contact.twitter && <div className="flex items-center gap-3 p-3 bg-gray-50 hover:bg-gray-100 transition-colors rounded-lg">
                  ...
                  {contact.facebook && <div className="flex items-center gap-3 p-3 bg-gray-50 hover:bg-gray-100 transition-colors rounded-lg">
                      <div className="bg-blue-100 p-2 rounded-lg">
                  ...
                  {contact.instagram && <div className="flex items-center gap-3 p-3 bg-gray-50 hover:bg-gray-100 transition-colors rounded-lg">
                      <div className="bg-pink-100 p-2 rounded-lg">
            ...
            <div className="space-y-4">
              ...
              {interactions && interactions.length > 0 ? <div className="space-y-3">
                  {interactions.sort((a, b) => new Date(b.date).getTime() - new Date(a.date).getTime()).slice(0, 3).map(interaction => <div key={interaction.id} className="bg-gray-50 p-4 rounded-xl">
                  ...
                  {interactions.length > 3 && onViewAll && <Button variant="ghost" size="sm" className="w-full mt-3 text-blue-600 hover:text-blue-700 hover:bg-blue-50 text-sm font-medium" onClick={onViewAll}>
