...
export function EnhancedContactDetail({ 
  ...
  const getCircleColor = (circle: string) => {
    switch (circle) {
      case 'inner': return 'bg-green-100 text-green-800 dark:bg-green-900 dark:text-green-300';
      case 'middle': return 'bg-yellow-100 text-yellow-800 dark:bg-yellow-900 dark:text-yellow-300';
      case 'outer': return 'bg-gray-100 text-gray-800 dark:bg-gray-700 dark:text-gray-300';
        ...
        <TabsContent value="about" className="flex-1 mt-0">
          <ScrollArea className="h-full">
            <div className="p-6 space-y-6">
              ...
              {/* Social Links */}
              {(contact.linkedin || contact.website || contact.facebook) && (
                <div className="space-y-3">
