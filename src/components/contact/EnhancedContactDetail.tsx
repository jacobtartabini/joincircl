...
export function EnhancedContactDetail({ contact, interactions = [], onEdit, onDelete, onViewAll }: EnhancedContactDetailProps) {
  ...
  return (
    <div className="h-full overflow-y-auto pb-6 bg-white">
      ...
      <div className="p-6 flex flex-col items-center border-b">
        ...
        <h2 className="text-lg font-semibold text-center">{contact.name}</h2>
      ...
      <div className="p-4 border-b">
        <h3 className="text-xs font-semibold tracking-wider text-muted-foreground uppercase mb-3">Contact Details</h3>
      ...
      {(contact.job_title || contact.company_name || contact.industry) && (
        <div className="p-4 border-b">
          <h3 className="text-xs font-semibold tracking-wider text-muted-foreground uppercase mb-3">Professional</h3>
      ...
      {contact.notes && (
        <div className="p-4 border-b">
          <h3 className="text-xs font-semibold tracking-wider text-muted-foreground uppercase mb-3">Notes</h3>
      ...
      {contact.how_met && (
        <div className="p-4 border-b">
          <h3 className="text-xs font-semibold tracking-wider text-muted-foreground uppercase mb-3">How We Met</h3>
      ...
      {contact.hobbies_interests && (
        <div className="p-4 border-b">
          <h3 className="text-xs font-semibold tracking-wider text-muted-foreground uppercase mb-3">Hobbies & Interests</h3>
      ...
      {/* Timeline Section */}
      <div className="p-4">
        <h3 className="text-xs font-semibold tracking-wider text-muted-foreground uppercase mb-3">Recent Timeline</h3>
              ...
              .map((interaction) => (
                <div key={interaction.id} className="flex gap-3">
                  ...
                  <div className="flex-1 space-y-1">
                    ...
                    <p className="text-xs text-muted-foreground">{interaction.notes || "No notes"}</p>
                  </div>
                </div>
              ))}
