        ...
        <div className="flex justify-end gap-3">
          {onEdit && (
            <Button 
              ...
              size="sm" 
              onClick={onEdit} 
              className="h-9 px-4 text-sm font-medium border-gray-200 hover:bg-gray-50 hover:border-gray-300 transition-all duration-200"
            >
          ...
          {onDelete && (
            <Button 
              ...
              size="sm" 
              onClick={onDelete} 
              className="h-9 px-4 text-sm font-medium border-red-200 text-red-600 hover:bg-red-50 hover:border-red-300 transition-all duration-200"
            >
          ...
          {onViewAll && (
            <Button 
              ...
              size="sm" 
              onClick={onViewAll} 
              className="h-9 px-4 text-sm font-medium border-blue-200 text-blue-600 hover:bg-blue-50 hover:border-blue-300 transition-all duration-200"
            >
          ...
          <div className="text-center pb-8 border-b border-gray-100">
            ...
            <div className="flex flex-wrap gap-2 justify-center">
              ...
              {contact.tags && contact.tags.map(tag => (
                <Badge key={tag} variant="secondary" className="bg-gray-100 text-gray-700 border-gray-200 font-medium">
                  {tag}
                </Badge>
              ))}
            </div>
                ...
                <div className="space-y-4">
                  ...
                  {interactions.length > 3 && onViewAll && (
                    <Button 
                      variant="ghost" 
                      size="sm" 
                      className="w-full mt-4 text-blue-600 hover:text-blue-700 hover:bg-blue-50 font-medium" 
                      onClick={onViewAll}
                    >
