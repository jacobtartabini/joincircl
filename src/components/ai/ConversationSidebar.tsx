...
export default function ConversationSidebar({
  ...
  if (isCollapsed) {
    return <div className="w-16 bg-white/80 dark:bg-black/20 border-r border-white/20 dark:border-white/10 backdrop-blur-lg flex flex-col h-full">
        <div className="p-4 border-b border-white/20 dark:border-white/10 flex justify-center">
          <Button onClick={onToggleCollapse} variant="ghost" size="sm" className="w-8 h-8 p-0 glass-button">
  ...
  return <div className="w-80 bg-white/80 dark:bg-black/20 border-r border-white/20 dark:border-white/10 backdrop-blur-lg flex flex-col h-full">
      ...
      <div className="p-4 border-b border-white/20 dark:border-white/10">
        <div className="flex items-center gap-2 mb-3">
          <h2 className="font-semibold text-foreground text-center px-0 text-xl">Conversations</h2>
          <Button onClick={onToggleCollapse} variant="ghost" size="sm" className="ml-auto w-8 h-8 p-0 glass-button">
            <PanelLeft className="h-4 w-4" />
          </Button>
        </div>
        
        <Button onClick={onCreateConversation} className="w-full justify-start gap-2 glass-button rounded-full bg-[#0daeec]">
