...
export default function ConversationStarters({
  ...
  return <div className="max-w-4xl mx-auto px-6 py-8">
      ...
      <div className="grid grid-cols-1 md:grid-cols-2 gap-4">
        {prompts.map((prompt, index) => <Button key={index} variant="outline" onClick={() => onSelectPrompt(prompt.text)} className="h-auto p-4 text-left justify-start gap-3 glass-card hover:glass-card-enhanced transition-all rounded-2xl">
