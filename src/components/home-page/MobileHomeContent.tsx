      ...
      <div className="px-4 pt-6 pb-8 space-y-6">
          ...
          <form onSubmit={handleSearch} className="relative">
            <div className="relative">
              ...
              <Input
                ...
                className="pl-10 h-12 bg-gray-50 border-0 rounded-2xl text-base placeholder:text-gray-500 focus:bg-white focus:ring-2 focus:ring-blue-500/20 transition-all"
              />
            </div>
          </form>
        </div>
        ...
        <div className="flex gap-3">
          <Button 
            ...
            className="flex-1 h-12 bg-black text-white hover:bg-gray-800 rounded-2xl font-medium"
          >
          ...
          <Button 
            ...
            variant="outline"
            className="flex-1 h-12 border-gray-200 hover:bg-gray-50 rounded-2xl font-medium"
          >
      ...
      <Sheet open={isAddContactSheetOpen} onOpenChange={setIsAddContactSheetOpen}>
        <SheetContent side="bottom" className="h-[90vh] overflow-auto pt-6">
          ...
          <ContactForm 
            ...
            onCancel={() => setIsAddContactSheetOpen(false)}
          />
        </SheetContent>
      </Sheet>
      ...
      <Sheet open={isAddKeystoneSheetOpen} onOpenChange={setIsAddKeystoneSheetOpen}>
        <SheetContent side="bottom" className="h-[90vh] overflow-auto pt-6">
          ...
          <KeystoneForm 
            ...
            onCancel={() => setIsAddKeystoneSheetOpen(false)}
          />
        </SheetContent>
      </Sheet>
    </div>
