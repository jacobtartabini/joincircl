  ...
  return <div className="min-h-screen unified-web-theme">
      <div className="max-w-7xl mx-auto p-6 space-y-8">
        ...
        <div className="flex gap-3">
          <Button onClick={handleAddContact} className="unified-button rounded-full px-6 py-2 text-white transition-colors bg-[#0daeec] hover:bg-[#0daeec]/90">
            <Plus className="h-4 w-4 mr-2" />
            Add Contact
          </Button>
          <Button onClick={handleAddKeystone} variant="outline" className="unified-button rounded-full px-6 py-2 border-border hover:bg-accent transition-colors">
        ...
        <div className="grid grid-cols-1 md:grid-cols-3 gap-6">
          {stats.map((stat, index) => <Card key={index} className="unified-card hover:shadow-md transition-shadow">
          ...
          <div className="space-y-6">
            <Card className="unified-card">
              ...
              <CardContent className="space-y-3">
                <Button variant="ghost" onClick={() => navigate('/circles')} className="unified-button w-full justify-between p-4 h-auto hover:bg-accent rounded-full">
                ...
                <Button variant="ghost" onClick={() => navigate('/keystones')} className="unified-button w-full justify-between p-4 h-auto hover:bg-accent rounded-full">
                  <div className="flex items-center space-x-3">
                ...
                <Button variant="ghost" onClick={() => navigate('/ai-assistant')} className="unified-button w-full justify-between p-4 h-auto hover:bg-accent rounded-full">
                  <div className="flex items-center space-x-3">
