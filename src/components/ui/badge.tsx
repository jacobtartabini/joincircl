  ...
  'inline-flex items-center rounded-full text-xs font-medium ring-1 ring-inset transition-colors focus:outline-none focus:ring-2 focus:ring-ring focus:ring-offset-2',
  {
    variants: {
      variant: {
        ...
        purple: 'bg-brand/10 text-brand-600 ring-brand/30',
        pink: 'bg-destructive/10 text-destructive-600 ring-destructive/30',
        info: 'bg-brand/10 text-brand-600 ring-brand/30',
      },
      size: {
