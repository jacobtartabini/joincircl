  ...
  const filteredSortedContacts = useMemo(() => {
    ...
    let result = contacts.filter(contact => {
      if (searchQuery) {
        ...
        const matchesSearch = contact.name?.toLowerCase().includes(query) || contact.personal_email?.toLowerCase().includes(query) || contact.company_name?.toLowerCase().includes(query);
